...
public sealed partial class ShipyardConsoleMenu : FancyWindow
{
    ...
    public ShipyardConsoleMenu()
    {
        ...
        CategoriesOption.OnItemSelected += OnCategoryItemSelected;
        ClassesOption.OnItemSelected += OnClassItemSelected;
        EnginesOption.OnItemSelected += OnEngineItemSelected;
    ...
    public void PopulateCategories(List<string> availablePrototypes, List<string> unavailablePrototypes)
    {
        ...
        {
            CategoriesOption.AddItem(Loc.GetString($"shipyard-console-category-{str}"));
        }
    }
    ...
    public void PopulateClasses(List<string> availablePrototypes, List<string> unavailablePrototypes)
    {
        ...
        {
            ClassesOption.AddItem(Loc.GetString($"shipyard-console-class-{str}"));
        }
    }
    ...
    public void PopulateEngines(List<string> availablePrototypes, List<string> unavailablePrototypes)
    {
        ...
        {
            EnginesOption.AddItem(Loc.GetString($"shipyard-console-engine-{str}"));
        }
    }
    ...
    // XAML Name= references (manual; avoids relying on the typed-name source generator).
    private Label BalanceLabel => this.FindControl<Label>("BalanceLabel")!;
    private Label ShipAppraisalLabel => this.FindControl<Label>("ShipAppraisalLabel")!;
    private LineEdit SearchBar => this.FindControl<LineEdit>("SearchBar")!;
    private OptionButton CategoriesOption => this.FindControl<OptionButton>("Categories")!;
    private OptionButton ClassesOption => this.FindControl<OptionButton>("Classes")!;
    private OptionButton EnginesOption => this.FindControl<OptionButton>("Engines")!;
    private BoxContainer Vessels => this.FindControl<BoxContainer>("Vessels")!;
    public Button TargetIdButton => this.FindControl<Button>("TargetIdButton")!;
    private ConfirmButton SellShipButton => this.FindControl<ConfirmButton>("SellShipButton")!;
    private ConfirmButton UnassignDeedButton => this.FindControl<ConfirmButton>("UnassignDeedButton")!;
    private Button SaveShipButton => this.FindControl<Button>("SaveShipButton")!;
    private Button LoadShipButton => this.FindControl<Button>("LoadShipButton")!;
    private Label DeedTitle => this.FindControl<Label>("DeedTitle")!;
    private BoxContainer RenameContainer => this.FindControl<BoxContainer>("RenameContainer")!;
    private LineEdit RenameLineEdit => this.FindControl<LineEdit>("RenameLineEdit")!;
    private Button RenameButton => this.FindControl<Button>("RenameButton")!;
    private ItemList SavedShipsList => this.FindControl<ItemList>("SavedShipsList")!;
}
